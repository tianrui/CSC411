...
def run_knn(k, train_data, train_labels, valid_data):
    ...
    """
    # print 'valid shape', valid_data.shape, 'train shape', train_data.shape
    # if valid_data.shape[0] != train_data.shape[0]:
    #     print 'shapes not equal in dim ', valid_data.shape[0], train_data.shape[0]
    # raw_input()
